...
class ParkTest {
    ...
    @Test
    void whenSetAmenity_thenAmenityIsSet() {
        Park.Amenity amenity = new Park.Amenity();
        amenity.setId("AMN1");
        amenity.setName("Restroom");
        amenity.setCategories(List.of("Facility"));
        assertEquals("AMN1", amenity.getId());
        assertEquals("Restroom", amenity.getName());
        assertEquals(List.of("Facility"), amenity.getCategories());
    }
}